...
body{
  /* background-color: #faffebb6; */
background-image: url('https://i.ibb.co/CzhMwGS/pexels-lumn-167699.jpg');
  color: #000000;
...
.quiz{
  ...
  max-width: 800px;
  border-radius: 10px;
  box-shadow: 1px 1px 15px #000000c2;
